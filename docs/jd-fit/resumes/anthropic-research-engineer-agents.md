...
**Research Engineer — Agent Harnesses · Agentic Benchmarks · Automated Evaluation**
...
## WHY ANTHROPIC — RESEARCH ENGINEER, AGENTS
...
- **Reward hacking caught as a measured weight, then rolled back** — github.com/wjlgatech/FM-os/tree/main/skills/product-rl-loop
- **FM-os — spec-as-data FM-ops hub (creator)** — github.com/wjlgatech/FM-os
- **A training API's primitives, keyless, with a forgetting gate** — github.com/wjlgatech/FM-os/tree/main/skills/tinker-loop
