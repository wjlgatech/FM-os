# Research Engineer, Winslow — Google DeepMind

**Fit:** 100/100 · **Location:** Mountain View, CA
**Apply:** https://www.google.com/about/careers/applications/jobs/results/76114032863388358-research-engineer-winslow-deepmind
**Resume:** [`resumes/gdm-winslow.pdf`](resumes/gdm-winslow.pdf)

> **Note:** Thinnest JD of the seven (552 words, few specific capability signals). Treat the low cap-count as missing information, not as an easy match.

## The angle

I ship gated closed loops: an independent referee, a pre-registered criterion, and a rollback when the number does not move. Breadth across eval, post-training and agent harnesses, with a measured artifact behind each.
...
This posting is the thinnest of the seven, so this resume leads with breadth and rigor rather than guessing at a specialization the JD does not name.
