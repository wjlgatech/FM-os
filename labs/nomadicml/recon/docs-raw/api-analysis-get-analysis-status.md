...
````yaml /openapi.json get /api/videos/{video_id}/analyses/{analysis_id}/status
openapi: 3.0.3
info:
  title: Nomadic API
  version: 1.0.0
...
paths:
  /api/videos/{video_id}/analyses/{analysis_id}/status:
    get:
      tags:
        - Analysis
      summary: Get analysis status
      description: Return status for a specific analysis document.
