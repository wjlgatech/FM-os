...
````yaml /openapi.json post /api/video/{video_id}/signed-url
openapi: 3.0.3
info:
  title: Nomadic API
  version: 1.0.0
...
paths:
  /api/video/{video_id}/signed-url:
    post:
      tags:
        - Videos
      summary: Create signed video URL
      description: Create a short-lived signed playback URL for a video.
      operationId: createSignedVideoUrl
      parameters:
        - name: video_id
          in: path
          required: true
