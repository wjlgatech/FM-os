...
````yaml /openapi.json get /api/videos/{video_id}/analyses/{analysis_id}
openapi: 3.0.3
info:
  title: Nomadic API
  version: 1.0.0
...
paths:
  /api/videos/{video_id}/analyses/{analysis_id}:
    get:
      tags:
        - Analysis
      summary: Get analysis document
      description: Return a specific analysis document for a video.
      operationId: getAnalysisDocument
      parameters:
        - name: video_id
          in: path
          required: true
        ...
        - name: analysis_id
          in: path
          required: true
          description: Nomadic analysis identifier.
          schema:
            type: string
      responses:
        '200':
