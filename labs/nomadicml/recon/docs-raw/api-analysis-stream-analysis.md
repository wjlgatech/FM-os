...
````yaml /openapi.json post /api/router/v2/query/stream
openapi: 3.0.3
info:
  title: Nomadic API
  version: 1.0.0
...
paths:
  /api/router/v2/query/stream:
    post:
      tags:
        - Analysis
      summary: Stream analysis
      description: >-
        Start a prompt-based analysis and stream progress events in the same
        response. Prefer the start/events flow for resumable clients.
