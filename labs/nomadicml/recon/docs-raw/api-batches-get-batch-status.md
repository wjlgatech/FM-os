...
````yaml /openapi.json get /api/batch/{batch_id}/status
openapi: 3.0.3
info:
  title: Nomadic API
  version: 1.0.0
...
paths:
  /api/batch/{batch_id}/status:
    get:
      tags:
        - Batches
      summary: Get batch status
      description: Return batch progress, status, and associated video pointers.
      ...
      parameters:
        ...
        - name: include_videos
          in: query
          required: false
          description: Whether to include video pointers.
          schema:
            type: boolean
            default: true
      responses:
